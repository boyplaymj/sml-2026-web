...
| 員工申報(反托) | 認證館家入駐須**申報旗下代表/員工名單** → 建立「館家↔人」關聯(反托連坐依據)→ [信任與安全](trust-safety) |
| 預約 | 時段桌位 → 建立預約 → 通知館家；可轉成揪團團局 |
| 打卡 | geofencing 進場偵測 → check-in → 點數/天梯加成（防作弊：需在圍欄內 + 冷卻） |
| 商業 | 合作館家可為付費/抽成對象（**若涉金流走成本規範**） |
| 場外觀(付費) | 場主訂閱可解鎖**地圖自訂圖標** / 招牌裝飾 → 詳見 [business 模組 §2.5](business)。護欄：騎模糊圈不露址、不得假冒認證徽章、免費場仍找得到 |
| B2B 曝光(付費) | **首頁置頂 / 優先搜尋**——標示「推廣」、不蓋過信譽/認證、不埋沒免費場 → [business §2.6](business) |
| 折價券 | 館家發券、玩家 App 領取、**到店折抵**；🔒 平台不經手金額(不賣券/不儲值)；可綁打卡解鎖 → [business §2.6](business) |
