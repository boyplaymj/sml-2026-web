...
DAYS = [
  ...
  {"no":5,"date":"5/28","wd":"四","theme":"寶可夢工藝展、諏訪神社與狸小路大採購",
   ...
   "intro":"札幌市區慢遊日：根室花丸平日不用久等、便宜又好吃；期待已久的寶可夢工藝展終於在近代美術館遇上，限定皮卡丘讓人失心瘋；北菓樓收齊北海道三大洋菓子。午後諏訪神社的花手水與御朱印美到選不完，一場雨把我們帶去三笠收人孔蓋、薄野駿河屋挖到絕版空姐皮卡丘，晚上松尾成吉思汗配大雨，最後在狸小路 donki 搬滿蛋白粉收工。","items":[
    ...
    {"time":"入座","ttl":"根室花丸・便宜又好吃","desc":"很快就入座了——不愧是北海道，隨便點都好吃，結帳金額還便宜到令人嚇一跳","tag":"🍣"},
    {"time":"下午","ttl":"寶可夢工藝展・北海道立近代美術館","desc":"吃完直奔北海道立近代美術館——這趟剛好遇到寶可夢工藝展在這裡展出，想逛很久了，這次時間對、地點也對；裡面很多日本工藝大師的寶可夢作品，非常厲害","tag":"🎨"},
    {"time":"工藝展","ttl":"限定皮卡丘・失心瘋商品部","desc":"最重要的商品販賣部有工藝展限定的皮卡丘，超可愛，各種商品都令人失心瘋","tag":"⚡"},
    {"time":"對面","ttl":"北菓樓・冰淇淋＆泡芙","desc":"逛完直接去美術館對面的北菓樓吃冰、吃泡芙——北海道三大洋菓子名店（六花亭、LeTAO、北菓樓）就這樣收集齊了","tag":"🍦"},
    {"time":"下午","ttl":"札幌諏訪神社・花手水","desc":"接著到札幌諏訪神社，這裡的花手水非常漂亮","tag":"⛩️"},
    {"time":"神社","ttl":"御朱印＆御神籤・多到選不完","desc":"御朱印種類繁多、每一款都很漂亮，超難選不知道挑哪些才好；連御神籤都有超多可以選","tag":"📜"},
    {"time":"下雨","ttl":"三笠・寶可夢人孔蓋","desc":"開始下雨，索性開去三笠蒐集三笠的寶可夢人孔蓋","tag":"🕳️"},
    {"time":"傍晚","ttl":"薄野・駿河屋挖寶","desc":"蒐集完人孔蓋往薄野的駿河屋，挖到前一代新千歲機場限定的空姐皮卡丘","tag":"🛍️"},
    {"time":"晚餐","ttl":"松尾ジンギスカン・すすきの店","desc":"超級大雨的晚上，就近吃成吉思汗烤肉——松尾ジンギスカン薄野店；北海道的羊肉、蔬果還有馬鈴薯，真的太好吃了","tag":"🐑"},
    {"time":"途中","ttl":"NIKKA 招牌・到此一遊","desc":"往狸小路的路上經過必拍的 NIKKA 威士忌大招牌，免不了拍一張到此一遊","tag":"📸"},
