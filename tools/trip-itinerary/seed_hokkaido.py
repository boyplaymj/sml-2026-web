...
DAYS = [
  ...
  {"no":6,"date":"5/29","wd":"五","theme":"寶可夢人孔蓋巡禮、Royce 工廠與富良野くまげら",
   ...
   "intro":"一早用 app 搶預約麥當勞吉伊卡哇二彈、bic camera 取餐、7-11 抽 sunsun 一番賞，回飯店把麥當勞當早餐。好天氣的行程前幾天都跑完了，這天就應壽星許願一路蒐集寶可夢人孔蓋——當別『北歐の風』、富良野日之出公園、砂川六尾＆胖甜妮，中途被 hobby off 的戰鬥陀螺吸進去、順逛 Royce 工廠掃限定伴手禮，晚餐意外吃到緯來日本台拍過的富良野くまげら。","items":[
    {"time":"一早","ttl":"手機預約麥當勞・吉伊卡哇第二彈","desc":"一早起床先用手機 app 預約麥當勞快樂兒童餐的吉伊卡哇第二彈——這次為了防黃牛，開賣首日要用 app 預約才能購買","tag":"🍟"},
    {"time":"取餐","ttl":"bic camera 內麥當勞取餐＋玩具樓層","desc":"走去飯店附近 bic camera 裡的麥當勞取餐，順便逛了玩具樓層，戰鬥陀螺 BEYBLADE X 一整排","tag":"🛗",
     "photos":[PH+"d6-beyblade-shelf.jpg"],"caption":"玩具樓層・戰鬥陀螺 BEYBLADE X"},
    ...
    {"time":"途中","ttl":"hobby off・被戰鬥陀螺吸進去","desc":"預計第一站是當別的人孔蓋，結果途中經過 hobby off 就被吸進去，買了一堆戰鬥陀螺","tag":"🌀"},
    ...
    {"time":"當別","ttl":"當別・寶可夢人孔蓋（北歐の風 道之驛）","desc":"當別的寶可夢人孔蓋（アローラロコン＆ポットデス）在『北歐の風 道之驛』，在這裡買了冰淇淋、豬肉香腸，還有看大家都拿就跟著拿的麵包","tag":"🕳️",
     "photos":[PH+"d6-tobetsu-manhole.jpg"],"caption":"當別とうべつ・寶可夢人孔蓋"},
    {"time":"附近","ttl":"Royce 巧克力工廠・限定伴手禮","desc":"蒐集完這站，去附近的 Royce 巧克力工廠，買了很多限定伴手禮，還有 Royce 麵包","tag":"🍫"},
