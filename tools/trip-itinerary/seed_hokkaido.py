...
DAYS = [
  ...
  {"no":7,"date":"5/30","wd":"六","theme":"30 週年一番賞 LAST 賞、合體御朱印與新千歲前夜",
   ...
   "intro":"最後的尋寶衝刺：一早寶可夢中心抽 30 週年一番賞、機台打到鳳王洛奇亞，東急搞怪書店找六尾、一番賞官方店收 LAST 賞。還車前趕去伊達神社補齊諏訪神社的合體御朱印，Gusto 登別店趕寶可夢聯名尾聲；加油還車後入住機場旁飯店，機場大多打烊只吃到札幌拉麵，帶杯限定星巴克回房泡湯。","items":[
    ...
    {"time":"中心","ttl":"一番賞戰利品＆中心新品","desc":"一番賞從獎品架抽到大皮卡丘和一整組御三家娃娃，中心新品的謎擬Q大抱枕也超可愛，滿載而歸","tag":"🎁",
    ...
    {"time":"晚餐","ttl":"札幌拉麵","desc":"晚餐就在機場吃了一碗札幌味噌拉麵，濃郁湯頭配叉燒、木耳，替這天收尾","tag":"🍜",
     "photos":[PH+"d7-sapporo-ramen.jpg"],"caption":"機場的札幌味噌拉麵"},
    ...
    {"time":"住宿","ttl":"PORTOM INTERNATIONAL HOKKAIDO","desc":"機場旁的飯店，回房泡湯放鬆，替倒數第二晚畫下句點","tag":"🛏️","stay":True},
  ]},
