...
DAYS = [
  ...
  {"no":6,"date":"5/29","wd":"五","theme":"寶可夢人孔蓋巡禮、Royce 工廠與富良野くまげら",
   ...
   "intro":"一早用 app 搶預約麥當勞吉伊卡哇二彈、yodobashi 取餐、7-11 抽 sunsun 一番賞，回飯店把麥當勞當早餐。好天氣的行程前幾天都跑完了，這天就應壽星許願一路蒐集寶可夢人孔蓋——當別『北歐の風』、富良野日之出公園、砂川六尾＆胖甜妮，中途被 hobby off 的戰鬥陀螺吸進去、順逛 Royce 工廠掃限定伴手禮，晚餐意外吃到緯來日本台拍過的富良野くまげら。","items":[
    ...
    {"time":"路過","ttl":"Royce Town 車站","desc":"路上還經過 JR 北海道的 Royce Town 車站，這座車站就在 Royce 巧克力工廠旁","tag":"🚉",
     "photos":[PH+"d6-royce-station.jpg"],"caption":"JR Royce Town 車站"},
    ...
    {"time":"道之驛","ttl":"北歐の風・採買袋（跟風麵包＆北海道杯湯）","desc":"麵包區看大家都在拿，就也跟著拿了幾個吐司，再配上北海道限定的 Knorr 杯湯，道之驛採買滿滿一袋","tag":"🛍️",
     "video":{"src":PH+"d6-royce-haul.mp4","poster":PH+"d6-royce-haul-poster.jpg"}},
    {"time":"附近","ttl":"Royce 巧克力工廠・限定伴手禮","desc":"蒐集完這站，去附近的 Royce 巧克力工廠，買了很多限定伴手禮；館內連座位區都佈置得像巧克力世界，深咖啡方格軟墊根本就是一整片巧克力磚","tag":"🍫",
     "photos":[PH+"d6-royce-chair.jpg"],"caption":"Royce 工廠・坐在像巧克力磚的座位上"},
    {"time":"工廠","ttl":"Royce 麵包・NO.1 人氣","desc":"工廠麵包區掛著 NO.1 人氣招牌，大家都在拿，Royce 麵包也掃了幾個","tag":"🥐",
     "video":{"src":PH+"d6-bread.mp4","poster":PH+"d6-bread-poster.jpg"}},
    {"time":"工廠","ttl":"Royce Town 車站模型鑰匙圈","desc":"工廠賣店還入手了 Royce Town 車站造型的模型鑰匙圈","tag":"🔑",
     "photos":[PH+"d6-royce-station-model.jpg"],"caption":"Royce Town 車站造型・模型鑰匙圈"},
  ...
  {"no":7,"date":"5/30","wd":"六","theme":"30 週年一番賞 LAST 賞、合體御朱印與新千歲前夜",
   "kicker":"Day 7 · 5/30 週六",
   "intro":"最後的尋寶衝刺：一早寶可夢中心抽 30 週年一番賞、機台打到鳳王洛奇亞，東急搞怪書店找六尾、一番賞官方店收 LAST 賞。還車前趕去伊達神社補齊諏訪神社的合體御朱印，Gusto 登別店趕寶可夢聯名尾聲；加油還車後入住機場旁飯店，機場大多打烊只吃到札幌拉麵，帶杯限定星巴克回房泡湯。","items":[
    {"time":"一早","ttl":"寶可夢中心・30 週年一番賞新上市","desc":"一早就衝寶可夢中心抽當天新上市的 30 週年一番賞；剛好也是中心上新品的日子，人非常多，新商品每個都可愛到不買不行","tag":"⚡",
     "reel":"https://www.instagram.com/reel/DY_-3gZTwlt/"},
    {"time":"中心","ttl":"一番賞戰利品＆中心新品","desc":"貨架上滿滿的一番賞獎品待抽；耿鬼的大抱枕軟Q軟Q有夠欠買","tag":"🎁",
     "gallery":[PH+"d7-ichiban-shelf.jpg",PH+"d7-mimikyu.jpg",PH+"d7-center-front.jpg"]},
    {"time":"順便","ttl":"寶可夢機台新活動・鳳王＆洛奇亞","desc":"順便打了寶可夢機台的新活動，打到了鳳王跟洛奇亞的卡","tag":"🎮",
     "photos":[PH+"d7-machine-cards.jpg"],"caption":"機台打到洛奇亞＆鳳王的卡"},
    {"time":"東急","ttl":"搞怪書店・當地應援六尾","desc":"接著去東急的搞怪書店（Village Vanguard），找當地應援寶可夢的六尾＆阿羅拉六尾","tag":"🦊",
     "photos":[PH+"d7-villevan-vulpix.jpg"],"caption":"北海道應援・六尾＆阿羅拉六尾"},
    {"time":"東急","ttl":"一番賞官方店・收穫 LAST 賞","desc":"然後在東急的一番賞官方店，收穫了 30 週年一番賞的 LAST 賞（ラストワン賞）——一隻大皮卡丘","tag":"🎯",
     "photos":[PH+"d7-lastprize.jpg"],"caption":"30 週年一番賞・LAST 賞大皮卡丘"},
    {"time":"還車前","ttl":"伊達神社・合體御朱印下半","desc":"之前在諏訪神社求了一張『可以合體』的御朱印，另一半在伊達神社；這天還車前特地趕去伊達神社，才完整了這張合體御朱印","tag":"⛩️",
     "photos":[PH+"d7-date-jinja.jpg"],"caption":"伊達神社・為合體御朱印補上另一半"},
    {"time":"御朱印","ttl":"合體御朱印・龍虎終於完整","desc":"諏訪神社的『龍』配上伊達神社的『虎』，兩張金箔御朱印拼在一起，龍虎合體終於完成，超有成就感","tag":"🐉",
     "video":{"src":PH+"d7-goshuin-gattai.mp4","poster":PH+"d7-goshuin-gattai-poster.jpg"}},
    {"time":"午餐","ttl":"Gusto 登別店・寶可夢聯名尾聲","desc":"還車前為了寶可夢聯名活動去吃 Gusto（登別店），但活動已到尾聲、聯名商品都沒了，只剩 Frienda 的卡匣還能拿；抽到的大皮卡丘也一起上桌陪吃","tag":"🍽️",
     "photos":[PH+"d7-gusto.jpg"],"caption":"帶著一番賞大皮卡丘一起吃 Gusto"},
    {"time":"還車","ttl":"加油＋還車","desc":"還車前記得先把油加滿，再把陪我們跑遍北海道的車還掉","tag":"⛽",
     "photos":[PH+"d7-gas.jpg"],"caption":"還車前・加滿最後一次油"},
    {"time":"傍晚","ttl":"新千歲機場（大多打烊）","desc":"本來預計早點還車逛新千歲機場，還車後才 check in 飯店；沒想到機場大部分店都關了，只剩吃的還開著，還好拍到『Memories of Hokkaido』的シマエナガ花藝，和 Hello Kitty Airline 的臉出拍照裝置","tag":"✈️",
     "gallery":[PH+"d7-airport-shimaenaga.jpg",PH+"d7-airport-hellokitty.jpg"]},
    {"time":"晚餐","ttl":"白樺山莊・札幌味噌拉麵","desc":"晚餐在機場吃白樺山莊的札幌味噌拉麵，濃郁湯頭配叉燒、木耳，還有可以免費吃到飽的水煮蛋，替這天收尾","tag":"🍜",
     "photos":[PH+"d7-sapporo-ramen.jpg"],"caption":"白樺山莊・札幌味噌拉麵（水煮蛋免費）"},
    {"time":"宵夜","ttl":"限定星巴克・回飯店泡湯","desc":"再買兩杯限定的星巴克，回飯店休息、好好泡個湯","tag":"☕",
     "photos":[PH+"d7-starbucks.jpg"],"caption":"機場限定星巴克・帶回房犒賞自己"},
    {"time":"回房","ttl":"PORTOM・攤開一天的戰利品","desc":"回到 PORTOM，把今天抽到的大皮卡丘和一整組御三家娃娃在床上排一排，戰利感十足","tag":"🧸",
     "photos":[PH+"d7-ichiban-loot.jpg"],"caption":"PORTOM 床上・今日一番賞戰利品大集合"},
    {"time":"住宿","ttl":"PORTOM INTERNATIONAL HOKKAIDO","desc":"從 Times 接駁車的國內線下車點走到飯店要走好長一大段路；但房間非常大、行李推車能直接推進房，隔天退房拉行李、一早趕飛機都超輕鬆，館內溫泉也很舒服，回房泡個湯替倒數第二晚畫下句點","tag":"🛏️","stay":True},
  ]},
