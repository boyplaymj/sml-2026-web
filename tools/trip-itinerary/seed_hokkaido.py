...
DAYS = [
  ...
  {"no":4,"date":"5/27","wd":"三","theme":"北海道神宮、小樽運河與寶可夢日K",
   ...
   "intro":"一早的獵人一番賞從第一天找到最後一天還是槓龜，索性玩娃娃機、扭皮克敏；到北海道神宮參拜、吃六花亭現烤判官さま，再把握好天氣殺去小樽——收人孔蓋、若鶏時代炸半雞、運河搭船、LeTAO 冰吃好吃滿。晚上回札幌登電視塔掃テレビ父さん周邊，最後在飯店旁卡拉OK體驗寶可夢30週年聯名的日K。","items":[
    ...
    {"time":"順手","ttl":"娃娃機＋皮克敏扭蛋","desc":"沒抽到就在旁邊娃娃機玩了一下，還扭了一顆皮克敏扭蛋","tag":"🎰"},
    {"time":"同棟","ttl":"東急 hands 逛逛","desc":"在同一棟的 hands 逛了一圈","tag":"🛒"},
    {"time":"上午","ttl":"北海道神宮・參拜","desc":"接著到北海道神宮參拜","tag":"⛩️"},
    {"time":"神宮","ttl":"六花亭・現烤判官さま","desc":"北海道神宮內的六花亭非常好吃好買，買了現烤的『判官さま』（判官樣）熱熱吃","tag":"🍡"},
    {"time":"把握好天氣","ttl":"前往小樽運河","desc":"把握最後的好天氣，開往小樽運河","tag":"🚗"},
    {"time":"小樽","ttl":"小樽・寶可夢人孔蓋","desc":"先收集小樽的寶可夢人孔蓋","tag":"🕳️"},
    {"time":"午餐","ttl":"若鶏時代・炸半雞","desc":"小樽名產若鶏時代的炸半雞，皮脆多汁","tag":"🍗"},
    {"time":"下午","ttl":"小樽運河・搭船","desc":"吃飽到運河搭遊船，從水上看小樽的紅磚倉庫","tag":"🚣"},
    {"time":"下午","ttl":"LeTAO・冰淇淋","desc":"搭完船來一支 LeTAO 冰淇淋，透心涼","tag":"🍦"},
    {"time":"傍晚","ttl":"開回札幌・札幌電視塔","desc":"晚上開回札幌，登上札幌電視塔","tag":"🗼"},
    {"time":"電視塔","ttl":"テレビ父さん周邊＋吉伊卡哇鐵牌","desc":"買了好多電視塔吉祥物『テレビ父さん』的周邊，還在這裡補到小樽沒買到的吉伊卡哇鐵牌","tag":"📺"},
    {"time":"晚上","ttl":"飯店旁卡拉OK・寶可夢30週年聯名","desc":"回飯店前，到飯店旁的卡拉OK唱歌——剛好有寶可夢 30 週年聯名活動；第一次體驗日本卡拉OK（日K），很有趣","tag":"🎤"},
