...
DAYS = [
  {"no":1,"date":"5/24","wd":"日","theme":"壽星降臨！機場尋寶、洞爺湖溫泉與煙火","hero":PH+"d1-pilot-pikachu.jpg",
   ...
   "items":[
    ...
    {"time":"一到","ttl":"新千歲機場・寶可夢商店","desc":"入手新千歲機場限定的『機長皮卡丘＆空姐皮卡丘』娃娃（門口還有一尊機長皮卡丘大公仔，貨架上整排都是）；反而是札幌寶可夢中心沒有自家的中心限定娃，機場先買先贏。旁邊扭蛋機還轉到一隻六尾","tag":"⚡",
     "gallery":[PH+"d1-pilot-pikachu.jpg",PH+"d1-pikachu-shelf.jpg",PH+"d1-gacha-vulpix.jpg"]},
