...
DAYS = [
  ...
  {"no":3,"date":"5/26","wd":"二","theme":"朝市帝王蟹、八幡宮御朱印與北上札幌",
   ...
   "intro":"晚出門的一天：先在函館車站旁松崗商店掃伴手禮、車站集章，原訂的朝市早餐順勢變成午餐——帝王蟹、現釣烏賊、螃蟹可樂餅，還喝到全程最好喝的駒ケ岳牛乳。午後到寧靜的函館八幡宮求限定新幹線御朱印，接著一路北上札幌，沿途逛玩具店、收集恵庭人孔蓋，很晚才進連泊基地。","items":[
    ...
    {"time":"午餐","ttl":"函館朝市・帝王蟹","desc":"因為晚出門，原本要當早餐的朝市變成了午餐。買了一隻帝王蟹，我們選了烤的，吃完覺得下次應該點蒸的","tag":"🦀"},
    {"time":"朝市","ttl":"現釣活烏賊","desc":"排了好久才輪到，現釣現切的活烏賊超新鮮","tag":"🦑"},
    {"time":"朝市","ttl":"駒ケ岳牛乳・全程最好喝","desc":"市場內一攤小販賣的駒ケ岳牛乳，是這趟旅程喝到最好喝的北海道牛奶","tag":"🥛"},
    {"time":"朝市","ttl":"螃蟹奶油可樂餅＆丼飯","desc":"再配上螃蟹奶油可樂餅和海鮮丼飯，朝市一次吃滿","tag":"🍤"},
    {"time":"下午","ttl":"函館八幡宮・限定新幹線御朱印","desc":"午後到函館八幡宮，這裡有限定的新幹線御朱印；是個很寧靜、很美的地方","tag":"⛩️"},
    {"time":"途中","ttl":"玩具店尋寶","desc":"往札幌的路上經過好幾間大型玩具店，進去找戰鬥陀螺，還有名偵探柯南、光之美少女的新商品","tag":"🧸"},
    {"time":"順路","ttl":"恵庭・寶可夢人孔蓋","desc":"北上途中順路收集恵庭的寶可夢人孔蓋","tag":"🕳️"},
    {"time":"很晚","ttl":"抵達札幌・進飯店休息","desc":"到札幌已經很晚，趕快進飯店休息","tag":"🌙"},
