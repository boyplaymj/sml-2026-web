...
DAYS = [
  ...
  {"no":2,"date":"5/25","wd":"一","theme":"人孔蓋巡禮、新選組變裝與百萬夜景",
   ...
   "items":[
    {"time":"早晨","ttl":"萬世閣 buffet 早餐","desc":"面湖飯店的自助早餐，吃飽再上路","tag":"🍽️"},
    ...
    {"time":"園內","ttl":"五稜郭・紫藤花瀑布","desc":"初夏限定的紫藤花瀑布，今年開得小小的，還是拍了幾張留念","tag":"🌸"},
    ...
    {"time":"夜晚","ttl":"函館山・百萬美元夜景","desc":"開車上函館山看百萬美元夜景，停車位繞好久才等到；夜景真的很美。山上一樣有觀光照可拍——實體照片只能寄日本地址，或選電子檔，我們選了兩種都有的方案，結果電子檔忘了下載、單子也丟了，還好留著實體照","tag":"🌃"},
    {"time":"順帶","ttl":"函館夜景款・吉伊卡哇鐵牌","desc":"函館山上也買得到函館夜景款吉伊卡哇鐵牌，可惜沒買到兔兔（うさぎ）；還好隔天在函館車站前的松崗商店補齊了兔兔","tag":"🩷"},
    {"time":"住宿","ttl":"Comfort Hotel 函館","desc":"下山已經很晚，就沒再去打機台，直接回 Comfort Hotel 函館休息睡覺，替滿滿一天的行程畫下句點","tag":"🛏️","stay":True},
  ]},
